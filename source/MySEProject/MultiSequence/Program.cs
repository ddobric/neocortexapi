...
namespace NeoCortexApiSample
{
    class Program
    {
        ...
        private static void RunMultiSimpleSequenceLearningExperiment()
        {
            ...
            sequences.Add("S1", new List<double>(new double[] { 1.0, 2.0, 4.0, 6.0, 8.0, 9.0, 10.0, }));
            sequences.Add("S2", new List<double>(new double[] { 12.0, 13.0, 15.0, 16.0, 17.0, 19.0, 20.0 }));
