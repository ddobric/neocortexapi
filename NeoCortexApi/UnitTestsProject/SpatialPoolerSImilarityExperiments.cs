...
namespace UnitTestsProject
{
    ...
    public class SpatialPoolerSimilarityExperiments
    {
        ...
        [DataRow("TestFiles")]
        public void SimilarityExperiment(string trainingFolder)
        {
            //string TestOutputFolder = $"Output-{nameof(SimilarityExperiment)}";

            //var trainingImages = Directory.GetFiles(trainingFolder, "digit7*.png");
            ...
            //        parameters.Set(KEY.INHIBITION_RADIUS, (int)0.02 * imageSizes[imSizeIndx] * imageSizes[imSizeIndx]);
