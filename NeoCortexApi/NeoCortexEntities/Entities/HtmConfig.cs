...
namespace NeoCortexApi.Entities
{
    ...
    public class HtmConfig
    {
        ...
        /// sides of length 2 * <see cref="PotentialRadius"/> + 1.<br/>
        /// 
        /// <b>WARNING:</b> <see cref="PotentialRadius"/> <b><i>must</i></b> be set to 
        /// the inputWidth if using <see cref="GlobalInhibition"/> and if not 
        ...
        /// ((2*<see cref="PotentialRadius"/> + 1)^(# <see cref="InputDimensions"/>) *
        /// <see cref="PotentialPct"/>) input bits to comprise the column's
        /// potential pool.
        /// </summary>
        ...
        /// <summary>
        /// Stimulus increment for synapse permanences below
        ...
        /// internally calculated <see cref="InhibitionRadius"/>, which is in
        ...
        /// <see cref="LocalAreaDensity"/> * (total number of columns in
        /// inhibition area).
        /// </summary>
        ...
        /// will insure that at most <see cref="NumActiveColumnsPerInhArea"/>
        ...
        /// <see cref="SynPermActiveInc"/>. Raising all permanences in response
        ...
        ///    max(other columns' duty cycles).<br/>
        ...
        /// <summary>
        /// he period used to calculate duty cycles. Higher
        ...
        /// <summary>
        /// Period count which is the number of cycles
